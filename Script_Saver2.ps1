...
Write-Host "  1. Windows (STRINGLN)    - wraps your commands in STRINGLN/END_STRINGLN"
Write-Host "  2. Linux (base64)        - encodes your bash script in base64"
Write-Host "  3. Raw Ducky             - saves your text exactly as written (Ducky syntax)"
Write-Host ""
...
# ============================================================
if ($scriptType -eq "RawDucky") {
    Write-Host "Type or paste your Ducky script below (RAW mode)." -ForegroundColor Cyan
    Write-Host "Each line will be saved exactly as you write it." -ForegroundColor White
} else {

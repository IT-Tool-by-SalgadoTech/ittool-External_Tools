...
# ============================================================
echo ""
echo -e "\e[36mChoose System folders to save:\e[0m"
echo "  1. Windows"
echo "  2. Linux"
echo ""
...
if [ "$SYSTEM" = "Windows" ]; then
    ...
    while [ -z "$TARGET_FOLDER" ]; do
        read -p "Folder number: " fc
        case "$fc" in
            1) TARGET_FOLDER="B.OS_System/B.Linux/A.Admin_And_Security" ;;
            2) TARGET_FOLDER="B.OS_System/B.Linux/B.Networks" ;;
            3) TARGET_FOLDER="B.OS_System/B.Linux/C.Folders_and_Files" ;;
            4) TARGET_FOLDER="B.OS_System/B.Linux/D.Storage" ;;
            5) TARGET_FOLDER="B.OS_System/B.Linux/E.Monitoring" ;;
            6) TARGET_FOLDER="B.OS_System/B.Linux/F.External_links_tools" ;;
            7) TARGET_FOLDER="B.OS_System/B.Linux/G.Nmap" ;;
            8) TARGET_FOLDER="B.OS_System/B.Linux/H.Kali_Linux" ;;
            0) TARGET_FOLDER="Favorites" ;;
            *) echo -e "\e[33m  Invalid option.\e[0m" ;;
        esac
    done
...
CTRL ALT T
DELAY 2500
STRING echo ${B64} | base64 -d > /tmp/ittool_run.sh && bash /tmp/ittool_run.sh
ENTER"

...
"
    ...
    # Linux: write script to /tmp via heredoc, then execute it
    # Same mechanism as Windows STRINGLN — no SD mount, no internet needed
    DUCK="DELAY 800
CTRL ALT T
DELAY 2500
STRING cat > /tmp/ittool_run.sh << 'ITTEOF'
ENTER
DELAY 200
STRINGLN
${USER_TEXT}
